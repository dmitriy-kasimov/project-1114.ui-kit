...
import { 
 ...
 const sidebarItems: SidebarItemType[] = [
    { description: <Text size="xl">Link1</Text>, onClick: () => console.log('Click on item 1') },
    { description: <Text size="xl">Link2</Text>, onClick: () => console.log('Click on item 2') },
    { description: <Text size="xl">Link3</Text>, onClick: () => console.log('Click on item 3') },
]
